...
public class AreasController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/queryAreasByParentId.do")
    public Map<String, Object> queryAreasByParentId(String parentId) {
        Map<String, Object> map = new HashMap<String, Object>();
        List<Areas> areasList = areasService.findList("parentId", Integer.valueOf(parentId));
        map.put("areasList", areasList);
        return map;
    }
