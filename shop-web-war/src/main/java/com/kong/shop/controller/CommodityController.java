...
public class CommodityController {
    ...
    public HashMap<String, Object> getCommodity(HttpServletRequest request, HttpServletResponse response, String id) {
        ...
        if (commodity != null && commodity.getPic() != null) {
            String[] images = commodity.getPic().split(",");
            if (commodity.getDatailPic() != null) {
                String[] detailPics = commodity.getDatailPic().split(",");
    ...
    public Map<String, Object> queryCommodityPage(HttpServletRequest request, HttpServletResponse response, String pageSize, String currentPage, Commodity commodity) {
        ...
        if (commodity != null) {
            ...
            if (commodity.getTypeId() != null) {
                ...
                searchField.setOp("=");
                searchField.setData(commodity.getTypeId());
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/queryCommoditySize.do")
    public Map<String, Object> queryCommoditySize(HttpServletRequest request, HttpServletResponse response) {
        Map<String, Object> map = new HashMap<String, Object>();
        List<ExCommodity> commodityList = new ArrayList<ExCommodity>();
        Map<String, Object> condition = new HashMap<String, Object>();
        int current = 0;
    ...
    @ResponseBody
    @RequestMapping(value = "/queryCommodityByType.do")
    public Map<String,Object> queryCommodityByType(String typeId,String name){
        Map<String,Object> map = new HashMap<String, Object>();
